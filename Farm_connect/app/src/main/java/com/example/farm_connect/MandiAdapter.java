...
public class MandiAdapter extends RecyclerView.Adapter<MandiAdapter.viewHolder> {
    ...
    public MandiAdapter(Context context, ArrayList<String> list, String[] links) {
        this.links=links;
    ...
    public viewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_categorymandi,parent, false);
