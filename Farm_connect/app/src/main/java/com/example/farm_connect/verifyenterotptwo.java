...
public class verifyenterotptwo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getotpbackrnd = getIntent().getStringExtra("backendotp");
        ...
        verifybuttonclick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!inputnumber1.getText().toString().trim().isEmpty()&&!inputnumber2.getText().toString().trim().isEmpty()&&!inputnumber3.getText().toString().trim().isEmpty()&&!inputnumber4.getText().toString().trim().isEmpty()&&!inputnumber5.getText().toString().trim().isEmpty()&&!inputnumber6.getText().toString().trim().isEmpty())
                {
                    ...
                    if(getotpbackrnd!=null)
                    {
                        progressBarverifyotp.setVisibility(View.VISIBLE);
                        verifybuttonclick.setVisibility(View.INVISIBLE);

                        PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.getCredential(
                                getotpbackrnd,entercodeotp
                        );
                    ...
                    {
                        Toast.makeText(verifyenterotptwo.this,"Please Check Connection",Toast.LENGTH_SHORT).show();
                    }
                    Toast.makeText(verifyenterotptwo.this,"OTP verify",Toast.LENGTH_SHORT).show();
                }
                else
                {
                    Toast.makeText(verifyenterotptwo.this,"Please enter OTP",Toast.LENGTH_SHORT).show();
                }
            }
        });
