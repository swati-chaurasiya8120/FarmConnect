...
public class Register extends AppCompatActivity {
    ...
    // declaring variable;
    Button  SignUpButtonInRegisterPage;
    EditText UserName_register , Email_Register , Contact_Register;
    EditText Password_Register , Confirm_pass_Register;
    FirebaseAuth mFirebaseAuth ;
    TextView LoginButtonInRegisterPage;
    FirebaseFirestore firestore;
    String userId;
    CheckValidation checkValidationMail, checkValidationContact;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SignUpButtonInRegisterPage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                 ...
                 */
                checkValidationMail = new CheckValidation(email_for_registration);
                checkValidationContact = new CheckValidation(contact_for_registration);


                if(username_for_Registration.isEmpty())
                    UserName_register.setError("Name required");
                else if(email_for_registration.isEmpty())
                    Email_Register.setError("Email required");
                else if(!checkValidationMail.isEmailValid())
                    Email_Register.setError("Invalid Email address");
                else if(contact_for_registration.isEmpty())
                    Contact_Register.setError("MobileNo required");
                else if(!checkValidationContact.isPhoneNumberValid())
                    ...
                    Confirm_pass_Register.setError("Weak Password");
